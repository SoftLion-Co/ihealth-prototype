    ...
    if (typeButton === "MainCartButton") {
      ...
      return (
        <Tag
          ...
          onClick={onClick}
          href={href}
          className={`${className} transition duration-300 ease-in-out flex flex-row items-center justify-center bg-transparent rounded border solid border-1 border-[#17696A] font-bold text-[#17696A] hover:text-[#ffffff] hover:bg-[#17696A] disabled:border-[#17696A] disabled:opacity-50 disabled:text-[#17696A] px-[24px] py-[9px] md:px-[32px] md:py-[11px] lg:px-[40px] lg:py-[14px]`}
        >
          {text}
        </Tag>
      );
